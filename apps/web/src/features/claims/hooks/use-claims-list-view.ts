...
import type { ClaimsFilterBarProps } from '@/features/claims/components/list/claims-filter-bar'
import type { ClaimsListHeaderProps } from '@/features/claims/components/list/claims-list-header'
import type { ClaimsListTableProps } from '@/features/claims/components/list/claims-list-table'
import type { ClaimsListSearch } from '@/features/claims/claims-list-search'
import { useListClaims } from './use-claims'
...
export interface UseClaimsListViewParams {
...
export function useClaimsListView({
  ...
  const chips = useMemo<ClaimsFilterBarProps['chips']>(() => {
    ...
    return nextChips
  }, [search.search, selectedStatuses, onToggleStatus, updateSearch, isStatusLocked])
