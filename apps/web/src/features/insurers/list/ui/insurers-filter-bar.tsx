...
export interface InsurersFilterChip {
  key: string
  label: string
  onRemove: () => void
}

export interface InsurersFilterBarProps {
  search: string
  onSearchChange: (value: string) => void
  isActive: boolean | undefined
  onIsActiveChange: (value: boolean | undefined) => void
  chips: InsurersFilterChip[]
  onClearAll: () => void
}
...
export function InsurersFilterBar({
  search,
  onSearchChange,
  isActive,
  onIsActiveChange,
