...
import type { ClientDetailSummaryItem } from '@/features/clients/detail/controller/use-client-detail-main-controller'

export interface ClientDetailSummaryCardProps {
  items: ClientDetailSummaryItem[]
}

export function ClientDetailSummaryCard({
  items,
